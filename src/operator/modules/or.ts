...
Test.Describe(
	...
	Test.It<Or<true, false>, true, Test.Out.PASS>(),
	Test.It<Or<true, boolean>, true, Test.Out.PASS>(),
	Test.It<Or<true, true>, true, Test.Out.PASS>(),
	Test.It<Or<false, false>, true, Test.Out.FAIL>(),
);
